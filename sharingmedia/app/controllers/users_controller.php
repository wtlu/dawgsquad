...
*/		
	function index(){
		...
		// construct facebook object for getting the session
		...
		// if the Session doesn't have a 'uid', redirect to login
...
*/	
	function login(){
		...
		// redirect to login if Session doesn't have 'uid' set or ask user for permissions if they haven't added the app
