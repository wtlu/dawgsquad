...
class UsersController extends AppController {
	...
	function index() {
		...
		if ($facebook->getSession()) {
			...
			$test_still_login = $facebook->getLoginStatusUrl("http://apps.facebook.com/sharingmedia/", "http://apps.facebook.com/sharingmedia/users/login/", "http://apps.facebook.com/sharingmedia/users/login/");
