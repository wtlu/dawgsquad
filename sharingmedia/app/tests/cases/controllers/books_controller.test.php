...
File: /app/tests/cases/books_controller.test.php
       ...
       This is the unit test module for BooksController function.
...
<?php
	...
	class BooksControllerTest extends CakeTestCase{
		 ...
		 *
		 * Note:
		 *		currently find_books_results does not take $sessionID as an argument. 
		 *		Thus, the test fails. However, this will be fixed in the future.
		 * 		which will output the correct value.
		 *
		 *
		 */
		function testFindBooksResults() {
			...
			debug('conducting render check for find_books_results() action method ');
				$result = $this->testAction('/Books/find_books_results/Web Programming/Marty Stepp/578012391/1', 
											array('return' => 'vars')
					);
