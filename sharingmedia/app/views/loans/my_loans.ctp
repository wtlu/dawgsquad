...
<div id="list">
	...
	?>
		<div class="book_unit">	
			...
			<?= $this->Html->link('Complete Loan',"/loans/complete_loan/".$book_collection[$i]["books"]["id"]."/".$loan_collection[$i]["loans"]["client_id"]."/".$loan_collection[$i]["loans"]["due_date"]."/", array('class' => 'buttons', 'escape' => false)); ?>
		</div>
	<?php
		}
