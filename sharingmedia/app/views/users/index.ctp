...
<div id="hello_message">
  <h1>Welcome <?php echo print($facebook_user["name"]); ?> to SharingMedia!</h1>
...
<div id="splash_boxes">
	<div class="box">
  	...
  	<div class="box">
  		...
  		<?php 
  		echo $this->Html->link($this->Html->image('my_library.png', array('alt' => 'MyLibrary')), "/users/comming_soon", array('escape' => false, 'id' => 'find_book_link'));
  		?>
