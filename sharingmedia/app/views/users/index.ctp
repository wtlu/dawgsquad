...
<div id="splash_boxes">
	<div class="box">
  	...
  	<div class="box">
  		...
  		<?php 
  		  echo $this->Html->link(
		  	...
		  	"http://apps.facebook.com/sharingmedia/index.php/books/find_books",
  	...
  	<div class="box">
  		...
  		<?php 
  		echo $this->Html->link($this->Html->image('my_library.png', array('alt' => 'MyLibrary')), "http://apps.facebook.com/sharingmedia/index.php/book_initial_offers/my_books", array('escape' => false, 'id' => 'find_book_link'));
  		?>
