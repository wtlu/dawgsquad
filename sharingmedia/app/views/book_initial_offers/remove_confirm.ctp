...
<div id = "remove_unit">
	<img class = "book_img" src = "<?php echo$offer[0]["books"]["image"]?>" alt="<?php echo $offer[0]["books"]["title"]?>"/> 
	<p>Are you sure you want to remove <?php echo$offer[0]["books"]["title"]?> by <?php echo$offer[0]["books"]["title"]?></p>
</div>
