...
<div id = "menubar">	
	<ul id = "menu">
		...
		<li><?= $this->Html->link('My Loans',"/sharingmedia/loans/my_loans", array('class' => 'tabs', 'escape' => false)); ?></li>
...
<?php		//loop to print out books		
	...
	?>
		<div class="book_unit">	
			...
			<?= $this->Html->link('Change Offer',"/sharingmedia/book_initial_offers/edit", array('class' => 'buttons', 'escape' => false)); ?>
		</div>
	<?php
		}
